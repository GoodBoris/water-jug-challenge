...
import { cpus } from 'os';
import { ParallelCalculateSolutionsStrategy } from '~/api/water-jug-solution/calculation-strategy/parallel-calculate-solutions-strategy.service';
import { SynchronousCalculateSolutionsStrategy } from '~/api/water-jug-solution/calculation-strategy/sync-calculate-solutions-strategy.service';

import {
  IWaterJugChallengeSolution,
} from '~/api/water-jug-solution/interfaces/water-jug-challenge-solution.interface';
...
export class WaterJugChallengeSolutionDto implements IWaterJugChallengeSolution {
